...
defaults write NSGlobalDomain defaults write -g ApplePressAndHoldEnabled -bool falseKeyRepeat -int 1
...
.ttfcurl -L https://github.com/kvndrsslr/sketchybar-app-fonfjcbvcehnct/releases/download/v2.0.28/sketbhybar-app-fontd-o $HOME/Library/Fonts/sketchybar-app-font.ttf
